                        ...
                        <form method="POST" action="{{ route('parent.meal-plans.generate') }}" class="ultra-form">
                            ...
                            <div class="form-section">
                                ...
                                <div class="ingredient-input-wrapper">
                                    ...
                                    <div id="ingredient-inline-error" role="alert">
                                        <i class="fas fa-exclamation-circle"></i>
                                        <span id="ingredient-inline-error-text"></span>
                                        <button class="ing-err-close" onclick="clearIngredientError()" aria-label="Dismiss">&times;</button>
                                    </div>
                                    <input type="hidden" name="available_foods" id="available_foods"
