...
<link rel="preload" href="@assetv('css/parent/view-meal-plans.css')" as="style">
...
<link rel="stylesheet" href="@assetv('css/parent/view-meal-plans.css')">
@endpush

@push('scripts')
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11" defer></script>
<script src="@assetv('js/parent/view-meal-plans.js')" defer></script>
@endpush
