...
<head>
    ...
    <link rel="stylesheet" href="@assetv('css/dashboard-modal.css')">
    <link rel="stylesheet" href="@assetv('css/modal-backdrop-fix.css')">
    ...
    <script src="@assetv('js/modal-cleanup.js')"></script>
    <script src="@assetv('js/dashboard-modal.js')"></script>
</head>
<body>
