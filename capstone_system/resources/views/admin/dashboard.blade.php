...
@push('styles')
    ...
    <link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css"
        ...
        crossorigin=""/>
    <!-- Admin Dashboard CSS -->
    <link rel="stylesheet" href="@assetv('css/admin/admin-dashboard.css')">
@endpush
...
@push('scripts')
    ...
    <script src="@assetv('js/admin/admin-dashboard-charts.js')"></script>
    
    <!-- Admin Dashboard JS -->
    <script src="@assetv('js/admin/admin-dashboard.js')"></script>
