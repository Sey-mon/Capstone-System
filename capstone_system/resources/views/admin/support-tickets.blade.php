...
@push('styles')
    <link rel="stylesheet" href="@assetv('css/admin/admin-users.css')">
    <link rel="stylesheet" href="@assetv('css/admin/support-tickets.css')">
...
@push('scripts')
    ...
    <script src="@assetv('js/admin/support-tickets.js')"></script>
@endpush
