...
@push('preload-styles')
    <link rel="preload" href="{{ asset('css/admin/foods.css') }}?v={{ filemtime(public_path('css/admin/foods.css')) }}" as="style" fetchpriority="high">
@endpush
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/foods.css') }}?v={{ filemtime(public_path('css/admin/foods.css')) }}">
@endpush
...
@push('scripts')
    ...
    <script defer src="{{ asset('js/admin/foods.js') }}?v={{ filemtime(public_path('js/admin/foods.js')) }}"></script>
@endpush
