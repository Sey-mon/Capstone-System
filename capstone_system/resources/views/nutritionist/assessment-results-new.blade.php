...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/nutritionist/assessment-results.css') }}?v={{ filemtime(public_path('css/nutritionist/assessment-results.css')) }}">
@endpush
...
@push('scripts')
    ...
    <script src="{{ asset('js/nutritionist/assessment-results-new.js') }}?v={{ filemtime(public_path('js/nutritionist/assessment-results-new.js')) }}"></script>
@endpush
