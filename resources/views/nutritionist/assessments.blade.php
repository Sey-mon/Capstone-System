...
@push('head')
    ...
    <link rel="preload" href="@assetv('css/nutritionist-assessments.css')" as="style">
@endpush
...
@push('styles')
<link rel="stylesheet" href="@assetv('css/nutritionist-assessments.css')">
@endpush
...
<script src="@assetv('js/nutritionist-assessments.js')" defer></script>
