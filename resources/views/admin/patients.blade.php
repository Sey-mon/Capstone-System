...
@push('styles')
    <link rel="stylesheet" href="@assetv('css/admin/admin-patients.css')">
    <link rel="stylesheet" href="@assetv('css/admin/patients-archive.css')">
@endpush
...
@push('scripts')
    <script src="@assetv('js/admin/admin-patients-swal.js')"></script>
    <script src="@assetv('js/admin/patients-archive.js')"></script>
@endpush
