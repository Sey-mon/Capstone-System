...
@push('styles')
    <link rel="stylesheet" href="@assetv('css/admin/food-requests.css')">
@endpush
...
@push('scripts')
    <script src="@assetv('js/admin/food-requests.js')"></script>
    <script src="@assetv('js/admin/food-requests-enhanced.js')"></script>
@endpush
