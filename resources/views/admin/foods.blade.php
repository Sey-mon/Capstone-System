...
@push('preload-styles')
    <link rel="preload" href="@assetv('css/admin/foods.css')" as="style" fetchpriority="high">
@endpush
...
@push('styles')
    ...
    <link rel="stylesheet" href="@assetv('css/admin/foods.css')">
@endpush
...
@push('scripts')
    ...
    <script defer src="@assetv('js/admin/foods.js')"></script>
@endpush
